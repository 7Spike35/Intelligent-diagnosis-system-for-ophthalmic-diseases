...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        # Transformer
        self.transformerlayer = nn.TransformerEncoderLayer(d_model=768,nhead=4)
        self.transformer = nn.TransformerEncoder(self.transformerlayer,num_layers=6)
        ...
        self.fc = nn.Linear(pre_logits_size, 1024)
